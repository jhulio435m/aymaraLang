...
\begin{itemize}
    ...
    \item \textbf{FR-07} The system shall support an experimental LLVM backend that outputs \texttt{.ll}.
...
\begin{itemize}
    ...
    \item \textbf{IR-02} Options: \texttt{--debug}, \texttt{--dump-ast}, \texttt{--seed}, \texttt{--llvm}, \texttt{--windows}, \texttt{--linux}, \texttt{-o}.
