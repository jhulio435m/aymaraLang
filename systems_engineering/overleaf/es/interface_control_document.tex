...
\begin{itemize}
    ...
    \item \textbf{Opciones principales:} \texttt{--debug}, \texttt{--dump-ast}, \texttt{--seed}, \texttt{--windows}, \texttt{--linux}, \texttt{-o}.
\end{itemize}

\subsection{Sistema de archivos}
\begin{itemize}
    \item \textbf{Entradas:} archivos \texttt{.aym}.
    \item \textbf{Salidas:} \texttt{.asm} y binario nativo.
\end{itemize}

\subsection{Runtime}
\begin{itemize}
    \item \textbf{Interfaz:} llamadas a funciones integradas (\texttt{qillqa}, \texttt{katu}, \texttt{input}, matemáticas, arreglos, listas).
\end{itemize}
...
Codegen $\rightarrow$ Linker & \texttt{.asm} \\ \bottomrule
\end{longtable}
