...
\begin{itemize}
    ...
    \item Sistema de archivos (lectura \texttt{.aym}, escritura \texttt{.asm} y binarios).
\end{itemize}
...
Generación de código & AST validado & \texttt{.asm} \\
...
\begin{itemize}
    ...
    \item \textbf{FR-07} El sistema debe conservar un artefacto intermedio \texttt{.asm} previo al enlace.
    \item \textbf{FR-08} El sistema debe soportar módulos importados desde archivos externos.
    \item \textbf{FR-09} El sistema debe incluir funciones integradas (E/S, matemáticas, arreglos, aleatoriedad).
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{IR-02} Opciones: \texttt{--debug}, \texttt{--dump-ast}, \texttt{--seed}, \texttt{--windows}, \texttt{--linux}, \texttt{-o}.
    \item \textbf{IR-03} Archivos de salida: \texttt{.asm} (NASM) y ejecutable nativo.
\end{itemize}
...
FR-07 & Prueba & Se conserva artefacto \texttt{.asm} intermedio \\
...
FR-07 & \texttt{codegen/} & Artefacto NASM intermedio \\
FR-08 & \texttt{module\_resolver} & Resolución de módulos \\
FR-09 & \texttt{builtins/} & Funciones integradas \\ \bottomrule
\end{longtable}
