...
\begin{itemize}
    ...
    \item \textbf{FR-07} El sistema debe admitir un backend LLVM experimental que genere \texttt{.ll}.
...
\begin{itemize}
    ...
    \item \textbf{IR-02} Opciones: \texttt{--debug}, \texttt{--dump-ast}, \texttt{--seed}, \texttt{--llvm}, \texttt{--windows}, \texttt{--linux}, \texttt{-o}.
...
FR-07 & Prueba & Se genera archivo \texttt{.ll} \\
...
FR-07 & \texttt{codegen/llvm/} & LLVM IR \\
