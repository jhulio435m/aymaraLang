...
\subsection{Modo REPL para aprendizaje rápido}
\begin{enumerate}
    \item Usuario inicia \texttt{aymc --repl}.
    \item Escribe instrucciones de una línea.
    \item Observa resultados inmediatos.
\end{enumerate}
