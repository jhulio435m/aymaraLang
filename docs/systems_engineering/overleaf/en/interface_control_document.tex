...
\begin{itemize}
    ...
    \item \textbf{Main options:} \texttt{--repl}, \texttt{--debug}, \texttt{--dump-ast}, \texttt{--seed}, \texttt{--llvm}, \texttt{--windows}, \texttt{--linux}, \texttt{-o}.
\end{itemize}
...
\subsection{Runtime}
\begin{itemize}
    \item \textbf{Interface:} calls to built-in functions (\texttt{willt’aña}, \texttt{input}, math, arrays).
\end{itemize}
