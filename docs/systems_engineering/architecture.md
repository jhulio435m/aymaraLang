...
## 1. Visión general
AymaraLang está compuesto por un compilador modular (`aymc`), un runtime mínimo y herramientas de apoyo. La arquitectura sigue el flujo clásico de compiladores con módulos desacoplados.
