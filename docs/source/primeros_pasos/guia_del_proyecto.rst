...
La extensión básica para resaltado de sintaxis vive en
``vscode-extension/``. Para empaquetar un ``.vsix``, sigue las
instrucciones en
`vscode-extension/README.md <https://github.com/aymaraLang/aymaraLang/blob/main/vscode-extension/README.md>`_.

Documentación
-------------

El sitio de documentación está gestionado con **Sphinx** y vive en
``docs/source``. Para construirlo en local:
...
Este proyecto es abierto a toda colaboración. Nos interesa
especialmente:
...
..
   ...
   ✨ ¡Únete al desarrollo y forma parte del cambio
   tecnológico-cultural!

--------------

**Anterior:** :doc:`Instaladores <primeros_pasos/instaladores>`
